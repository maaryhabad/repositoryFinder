...
struct Repository: Hashable, Decodable {
    ...
    var stargazersCount: String = defaultText
    var watchersCount: String = defaultText
    
    init(repositoryName: String, description: String, url: String, ownerName: String, urlToImage: String, updatedAt: String, stargazersCount: String, watchersCount: String) {
